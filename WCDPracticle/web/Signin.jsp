<%-- 
    Document   : Signin
    Created on : Aug 29, 2024, 7:19:14 PM
    Author     : vihan
--%>
                        ...
                        <div class="col-12">
                            <form class="row g-2" action="SignIn" method="POST">
                                ...
                                <div class="offset-2 col-8 d-grid py-2">
                                    ...
                                    <a href="SignUp.jsp" class="link-dark text-center fw-bold text-decoration-none mt-2" style="font-size: 11px">Create New Account</a>
                                </div>
                            </form>
                        </div>
                    </div>
